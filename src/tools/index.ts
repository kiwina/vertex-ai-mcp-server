...
// import { moveMultipleFilesOrDirectoriesTool } from "./move_multiple_files_or_directories.js"; // Removed
import { searchFilesTool } from "./search_files.js";
import { getFileInfoTool } from "./get_file_info.js";
import { executeTerminalCommandTool } from "./execute_terminal_command.js";
...
// Import research-oriented tools
...
export const allTools: ToolDefinition[] = [
  ...
  directoryTreeTool,
  moveFileTool,
  // moveMultipleFilesOrDirectoriesTool, // Removed
  searchFilesTool,
  getFileInfoTool,
